...
const MainKeyboard = ({ onConsonantClick, highlightedConsonant, onSpace }) => {
  return (
    <motion.div
      ...
      className="bg-white/80 backdrop-blur rounded-3xl p-4 sm:p-6 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] border border-white/50"
    >
      ...
      <div className="max-w-2xl mx-auto mt-2">
        <motion.button
          ...
          onClick={onSpace}
          className="w-full h-14 bg-gray-50 border-b-4 border-gray-200 rounded-xl text-gray-400 font-bold text-lg tracking-widest hover:bg-gray-100 hover:border-gray-300 active:border-b-0 active:mt-1 transition-all shadow-sm flex items-center justify-center gap-2"
        >
          SPACE
        </motion.button>
      </div>
