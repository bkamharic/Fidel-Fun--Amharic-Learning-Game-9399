...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-gray-900 font-sans selection:bg-[#E63946]/30">
      
      {/* Top Header */}
      <header className="px-6 py-4 flex justify-between items-center bg-white shadow-lg sticky top-0 z-40 border-b-3 border-[#2A9D8F]/30">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-[#E63946] to-[#FF7043] rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-xl">
            ፊ
          </div>
          <div>
            <h1 className="text-xl font-bold text-gray-900 leading-none">Fidel Fun</h1>
            <p className="text-xs text-gray-700 font-medium">Interactive Learning</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
           ...
           <button
            ...
            className={`
              ...
              ${mode==='game' 
                ? 'bg-[#2A9D8F] text-white shadow-[#2A9D8F]/50 hover:bg-[#1E7A6F]' 
                : 'bg-[#FFD60A] text-gray-900 shadow-[#FFD60A]/50 hover:bg-[#FFC300]'}
            `}
          >
              ...
              <button
                ...
                className={`
                  ...
                  ${keyboardType==='letters'
                    ...
                    : 'bg-white border-gray-300 text-gray-700 hover:bg-[#F8F9FA]'}
                `}
              >
